...
extension RichTextView {
    ...
    public func setText(range: NSRange, type: MainView.KeyItemType) {
        ...
        case .bold:
            ...
            attributeStr.addAttribute(kCTFontAttributeName as NSAttributedString.Key, value: font , range: range)
        case .color:
            attributeStr.addAttribute(NSAttributedString.Key.foregroundColor, value: self.textStyle.fontColor , range: range)
        case .font:
            let font = self.textStyle.isBold ? UIFont.boldSystemFont(ofSize: self.textStyle.fontSize)
                : UIFont.systemFont(ofSize: self.textStyle.fontSize)
            attributeStr.addAttribute(kCTFontAttributeName as NSAttributedString.Key, value: font , range: range)
    ...
    var textStyle: RichTextStyle!{
        didSet {
            ...
            let attributes = [
                ...
                NSAttributedString.Key.foregroundColor: self.textStyle.fontColor
